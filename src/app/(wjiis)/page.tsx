...
export default function HomePage() {
  ...
  return (
    <>
      <DynamicSEO
        title="EJFFABLS - European Journal of Food, Fashion and Allied Bio-Life Sciences"
        description="A peer-reviewed international journal dedicated to publishing rigorous research in food sciences, fashion, and bio-life sciences."
        keywords={['food sciences', 'fashion research', 'bio-life sciences', 'research journal', 'academic publishing', 'EJFFABLS', 'peer review']}
        ogImage="https://ejffabls.com/og-image.jpg"
        canonicalUrl="https://ejffabls.com"
      />
      <WebsiteSchema
        name="EJFFABLS"
        url="https://ejffabls.com"
        description="A peer-reviewed international journal dedicated to publishing rigorous research in food sciences, fashion, and bio-life sciences."
        publisher="EJFFABLS"
      />
      <OrganizationSchema
        name="EJFFABLS"
        url="https://ejffabls.com"
        logo="https://ejffabls.com/ejffabls-logo.svg"
        description="EJFFABLS - European Journal of Food, Fashion and Allied Bio-Life Sciences"
        contactPoint={{
          email: "editor@ejffabls.com",
      ...
      <div className="min-h-screen font-sans">
        ...
        {/* Hero Section */}
        <section className="relative border-b border-slate-200" style={{background: 'linear-gradient(135deg, #2d5a2a 0%, #3d7a3a 100%)'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-8 space-y-6">
                <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold tracking-wide uppercase" style={{background: 'rgba(255,255,255,0.15)', color: '#d4af37'}}>
                  ISSN: 3142-9513 (Online)
                </div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight text-white">
                  ...
                  <span style={{color: '#d4af37'}}>Food, Fashion and Allied<br className="hidden md:block" />Bio-Life Sciences</span>
                </h1>

                <p className="text-xl max-w-2xl leading-relaxed" style={{color: '#e8d9b8'}}>
                  A peer-reviewed international journal dedicated to publishing rigorous research in food sciences, fashion, and bio-life sciences globally.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Link
                    ...
                    onMouseEnter={e => (e.currentTarget.style.background='#396b4a')}
                ...
                <div className="grid grid-cols-3 gap-8 pt-8 max-w-lg" style={{borderTop: '1px solid rgba(255,255,255,0.2)'}}>
                  <div>
                    ...
                    <div className="text-sm font-medium" style={{color: '#d4af37'}}>Research Articles</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">{stats.totalAuthors.toLocaleString()}+</div>
                    <div className="text-sm font-medium" style={{color: '#d4af37'}}>Global Contributors</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">20+</div>
                    <div className="text-sm font-medium" style={{color: '#d4af37'}}>Indexed In</div>
                  </div>
                </div>
              </div>
        ...
        {/* Why Choose Us */}
        <section className="py-16 border-y border-slate-200" style={{background: '#f7f9f2'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-serif font-bold mb-4" style={{color: '#2d5a2a'}}>Journal Features</h2>
              <p className="text-slate-600 max-w-2xl mx-auto">
                We are committed to the highest standards of academic publishing in food, fashion, and bio-life sciences.
              </p>
            </div>

            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                { icon: Globe, title: 'Global Reach', desc: 'Connecting food and bio-life researchers from over 70 countries.' },
                { icon: Shield, title: 'Rigorous Peer Review', desc: 'Double-blind review process ensuring quality and objectivity in food science research.' },
                { icon: Zap, title: 'Rapid Publication', desc: 'Efficient processing with an average turnaround of 4-6 weeks.' },
                { icon: BookOpen, title: 'Open Access', desc: 'Free unrestricted access to all published food and fashion research.' },
                { icon: Target, title: 'High Visibility', desc: 'Indexed in major academic databases for maximum food science citation.' },
                { icon: CheckCircle2, title: 'Ethical Standards', desc: 'Strict adherence to COPE guidelines for publication ethics.' }
              ].map((feature, index) => (
                <div key={index} className="bg-white rounded-lg p-6 shadow-sm" style={{border: '1px solid #d4d4b8', borderTop: '3px solid #4a7c59'}}>
                  <feature.icon className="w-8 h-8 mb-4" style={{color: '#2d5a2a'}} />
                  <h3 className="text-lg font-bold mb-2" style={{color: '#2d5a2a'}}>{feature.title}</h3>
        ...
        {/* CTA */}
        <section className="py-16 text-white" style={{background: 'linear-gradient(135deg, #2d5a2a 0%, #3d7a3a 100%)'}}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 text-white">
              Submit Your Food & Fashion Research Today
            </h2>
            <p className="mb-8 text-lg" style={{color: '#e8d9b8'}}>
              Join our community of food and bio-life researchers and contribute to advancing global knowledge.
            </p>
